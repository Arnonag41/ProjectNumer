        ...
        return (
            <div >
                ...
                <Content onChange={this.handleChange} >
                    ...
                    >
                    <br/><br/>
                    <h1 style={{ marginLeft: "80%" , fontSize: "20px"}}>f(x)<br/>
                    <Input size="large" name="fx1"  style={{ width: 300, background: "#daedf5" }} /></h1>
                    <h1 style={{ marginLeft: "80%" , fontSize: "20px" }}>f'(x)<br/>
                    <Input size="large"   name="fx2" style={{ width: 300, background: "#daedf5" }} /></h1>
